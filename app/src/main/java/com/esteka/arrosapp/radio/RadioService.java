...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener, MetadataOutput {
    ...
    public void onMetadata(Metadata metadata) {
        mMetadata = metadata;
        onPlayerStateChanged(false, STATE_METADATA);
    }
    ...
    public void onCreate() {
        ...
        mediaSession.setMetadata(new MediaMetadataCompat.Builder()
                ...
                .putString(MediaMetadataCompat.METADATA_KEY_TITLE, getResources().getString(R.string.live_broadcast))
                .build());
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        ...
        switch (playbackState) {
            ...
            case Player.STATE_READY:
                ...
                break;
            case STATE_METADATA:
                status = PlaybackStatus.METADATA;
                break;
            default:
                status = PlaybackStatus.IDLE;
                break;
...
//        DefaultHttpDataSourceFactory dataSourceFactory = new DefaultHttpDataSourceFactory(getUserAgent());
    ...
    public void stop() {
        ...
        audioManager.abandonAudioFocus(this);
        wifiLockRelease();
        // Exoplayer does not send stop status when stopped manually
        onPlayerStateChanged(false, Player.STATE_ENDED);
    }
